        ...
        case "2":
            ...
            for (int i = 0; i < maxPets; i++)
            {
                if (ourAnimals[i, 1].Contains("dog"))
                {
                    ...
                    foreach (var search in dogCharacteristics)
                    {
                        for (int j = 2; j > -1; j--)
                        {
                            ...
                            {
                                Console.Write($"\rsearching ... {search} {icon} {j.ToString()} ");
                                Thread.Sleep(150);
                            }
                        ...
                        if (dogDescription.Contains(" " + search.Trim() + " "))
                        {
                            matchesCurrentDog = true;
                            matchesAnyDog = true;
                            Console.WriteLine($"Our dog {ourAnimals[i, 3]} is a {search} match!");
                        }
                    }
